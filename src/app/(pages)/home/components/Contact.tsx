  ...
  return (
    <section className="section bg-light" id="contact">
      <Container>
        <Row>
          <Col xs={12}>
            <Card className="bg-white contact-card-bg">
              <CardBody>
                <Row>
                  <Col xs={12} md={8} className="order-2 order-md-1">
                    ...
                    <form method="post" name="myForm" onSubmit={handleSubmit(() => { })}>
                      ...
                      <Row>
                        ...
                        <Col xs={12}>
                          <Button type="submit" id="submit" className="btn btn-primary mt-2 w-100 w-md-auto">
                            Send message
                          </Button>
                        </Col>
                      </Row>
                  ...
                  <Col xs={12} md={4} className="order-1 order-md-2 mb-4 mb-md-0">
                    <img src={contactImg} alt='contactImg' height={200} className="mx-auto d-block mb-5 img-fluid" style={{ maxHeight: '200px' }} />
